/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 41a37e49976b64e03f1fb11664f5703c)
// Runtime types generated with workerd@1.20260811.1 2026-08-03 nodejs_compat
interface __BaseEnv_Env {
	THUMBNAILS: R2Bucket;
	DB: D1Database;
	TAXONOMY_QUEUE: Queue;
	IMAGES: ImagesBinding;
	ENVIRONMENT: "production";
	PUBLIC_SITE_URL: "https://oddweb.page";
	TURNSTILE_HOSTNAMES: "oddweb.page";
	TURNSTILE_SITEKEY: "replace-with-production-sitekey";
	RELEASE_SHA: "development";
	RELEASE_TIME: "development";
	RELEASE_FENCE_VERSION: "1";
	ADMIN_USERNAME: string;
	ADMIN_PASSWORD_HASH: string;
	ADMIN_SESSION_SECRET: string;
	TAXONOMY_MASTER_KEY_V1: string;
	TURNSTILE_SECRET: string;
	REALTIME_HUB: DurableObjectNamespace<import("./src/server").RealtimeHub>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PUBLIC_SITE_URL" | "TURNSTILE_HOSTNAMES" | "TURNSTILE_SITEKEY" | "RELEASE_SHA" | "RELEASE_TIME" | "RELEASE_FENCE_VERSION" | "ADMIN_USERNAME" | "ADMIN_PASSWORD_HASH" | "ADMIN_SESSION_SECRET" | "TAXONOMY_MASTER_KEY_V1" | "TURNSTILE_SECRET">> {}
}
